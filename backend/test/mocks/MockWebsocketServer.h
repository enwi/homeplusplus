...
{
public:
    MockWebsocketMessage() = default;
    MockWebsocketMessage(const nlohmann::json& payload) : payload(payload.dump())
    {
        using namespace ::testing;
        EXPECT_CALL(*this, get_payload()).Times(AnyNumber()).WillRepeatedly(ReturnRef(this->payload));
    }
...
public:
    ...
    MockIoService get_io_service() { return {}; }
};
